...
namespace CarScope.Controllers
{
    public class BankAccountsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ID,Name,AccNo,AvailableBal")] BankAccount bankAccount)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ID,Name,AccNo,AvailableBal")] BankAccount bankAccount)
        {
